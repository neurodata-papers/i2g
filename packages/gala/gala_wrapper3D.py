...
args = [wrapper] + [os.path.join(frameworkRootI2G, 'packages', 'gala', 'gala_get_data3D.m')] + emToken + emServiceLocation + membraneToken + membraneServiceLocation + queryFile + emCube + emMat + membraneMat + wsMat + dilateXY + dilateZ + wsThresh + useSemaphore
print args
# Call Cube Cutout
