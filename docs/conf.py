# -*- coding: utf-8 -*-
#
# i2g documentation build configuration file, created by
...
#sys.path.insert(0, os.getenv('i2g_HOME'))
...
#import docs.scripts.i2g
#import docs.scripts.i2g_registration
#import docs.scripts.i2g_diffusion
...
latex_documents = [
  (master_doc, 'i2g.tex', u'i2g Documentation',
   u'OCP', 'manual'),
]
...
man_pages = [
    (master_doc, 'i2g', u'i2g Documentation',
     [author], 1)
]
...
texinfo_documents = [
  (master_doc, 'i2g', u'i2g Documentation',
   author, 'i2g', 'One line description of project.',
   'Miscellaneous'),
]
